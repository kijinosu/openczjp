...
`Acemoglu et al (2016) <ref-acemoglu2016import_>`_ use CZs to analyse the effect of Chinese imports on employment in the United States and find that import growth from China between 1990 and 2011 led to an employment reduction of 2.4 million workers.
